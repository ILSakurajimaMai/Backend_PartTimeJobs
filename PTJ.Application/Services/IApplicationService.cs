...
public interface IApplicationService
{
    ...
    Task<Result<PaginatedList<ApplicationDto>>> GetByCVIdAsync(int profileId, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
    Task<Result<PaginatedList<ApplicationDto>>> GetByUserIdAsync(int userId, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
